...
# Connect to MongoDB
client = MongoClient('mongodb+srv://doadmin:78q1Aj0px6352kcm@db-mongodb-nyc1-51418-f4c19a18.mongo.ondigitalocean.com/admin?tls=true&authSource=admin')
db = client['admin']
...
for table in tables:
    ...
    for row in table.find_all('tr')[1:]:
        ...
        domain = domain.lstrip('https://www.').lstrip('http://www.').rstrip('/')
